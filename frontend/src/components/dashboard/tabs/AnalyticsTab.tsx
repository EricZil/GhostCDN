...
export const AnalyticsTab: React.FC<AnalyticsTabProps> = ({
  ...
  const [activeView, setActiveView] = useState<'api' | 'realtime' | 'files'>('api');
    ...
    <div className="space-y-6">
      ...
      {activeView === 'api' ? (
        ...
        <div className="relative">
          {/* File Analytics Content (blurred) */}
          <div className="space-y-6 blur-sm pointer-events-none">
            {/* Analytics Header with Period Selector */}
            <div className="flex items-center justify-between">
              <h3 className="text-2xl font-semibold text-white">File Analytics Dashboard</h3>
          ...
          <div className="absolute inset-0 bg-black/30 backdrop-blur-sm flex items-center justify-center z-10">
            <div className="text-center space-y-6 p-8">
              ...
              <div>
                <h3 className="text-3xl font-bold text-white mb-3">File Analytics</h3>
                <p className="text-xl text-gray-300 mb-2">Coming Soon</p>
                <p className="text-base text-gray-400 max-w-lg mx-auto leading-relaxed">
                  File view tracking and analytics will be implemented in a future update to provide detailed insights about your uploaded files and their performance.
                </p>
              </div>
