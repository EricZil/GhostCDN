                  ...
                  <AnimatePresence mode="wait">
                        ...
                        <div className="bg-purple-500/5 rounded-xl p-8 border border-purple-500/20">
                          <div className="mb-6">
                            <div className="flex justify-between text-base mb-3">
                              ...
                              <span className="font-medium text-white text-lg">0 GB / 10 GB</span>
                            </div>
                            <div className="w-full bg-gray-800 rounded-full h-3">
                              <div className="bg-gradient-to-r from-purple-600 to-pink-600 h-3 rounded-full transition-all duration-500" style={{ width: '0%' }} />
                            </div>
                            <p className="text-sm text-gray-500 mt-2">10 GB available</p>
                          </div>
                    ...
                    {activeTab === 'api' && (
                      <motion.div
                        ...
                        transition={{ duration: 0.2 }}
                      >
                        <h3 className="text-2xl font-semibold text-white mb-6">API Keys</h3>
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-xl p-6 mb-8">
                          <div className="flex">
                            <svg className="w-6 h-6 text-yellow-400 mr-3 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                              <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                            </svg>
                            <div className="text-base text-yellow-300">
                              <p className="font-medium text-lg mb-1">API Access Coming Soon</p>
                              <p className="text-yellow-300/80">API key generation and management will be available in a future update. This will allow you to integrate GhostCDN with your applications.</p>
                            </div>
                          </div>
                        </div>
                        <div className="space-y-6">
                          <div className="bg-purple-500/5 rounded-xl p-8 border border-purple-500/20">
                            <h4 className="font-medium text-white text-lg mb-4">What you&apos;ll be able to do:</h4>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="flex items-start">
                                ...
                                <div>
                                  <p className="text-white font-medium">Generate API Keys</p>
                                  <p className="text-sm text-gray-400 mt-1">Create multiple keys for different applications</p>
                                </div>
                              </div>
                              <div className="flex items-start">
                                <svg className="w-6 h-6 text-green-400 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                  <p className="text-white font-medium">Programmatic Upload</p>
                                  <p className="text-sm text-gray-400 mt-1">Upload files directly from your applications</p>
                                </div>
                              </div>
                              <div className="flex items-start">
                                <svg className="w-6 h-6 text-green-400 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                  <p className="text-white font-medium">File Management</p>
                                  <p className="text-sm text-gray-400 mt-1">List, update, and delete files via API</p>
                                </div>
                              </div>
                              <div className="flex items-start">
                                <svg className="w-6 h-6 text-green-400 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-400 mt-1">Set custom limits and permissions per key</p>
                                </div>
                              </div>
                            </div>
                          </div>
